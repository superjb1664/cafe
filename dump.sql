...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 07 oct. 2021 à 11:12
...
INSERT INTO `salarie` (`idSalarie`, `nom`, `prenom`, `mail`, `idEntreprise`, `roleEntreprise`, `password`, `actif`) VALUES
    (10, 'test2', 'testaerbv', 'contact@lyceep.fr', 20, 'test', '$2y$10$UI.w13KAI/Nidcuj3CSeduyI3hrMYcCljgXAsnc/VLjhcvsfmpM.G', b'1');
...
INSERT INTO `utilisateur` (`idUtilisateur`, `login`, `motDePasse`, `niveauAutorisation`, `desactiver`) VALUES
                                                                                                           (1, 'root', '$2y$10$Sd2B1bNXYey7UjBdMg2ybuFxYh.XIM1NhYirQ.4OtwxP1GAL2aN5i', 1, 0),
...
--
ALTER TABLE `historique_etat_commande`
    MODIFY `idHistorique` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `salarie`
    MODIFY `idSalarie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

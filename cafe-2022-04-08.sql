...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 08 avr. 2022 à 13:14
...
(1, 2, 2, '2021-10-07 01:02:59', '', NULL, NULL),
(2, 3, 2, '2021-10-07 01:05:38', '', NULL, NULL),
(3, 4, 2, '2021-10-07 01:16:28', 'Commande passée par test2 testaerbv', NULL, NULL),
(4, 4, 3, '2021-10-07 10:30:33', '', -1, 1),
(5, 4, 3, '2021-10-07 10:30:37', '', -1, 1),
(6, 4, 3, '2021-10-07 10:35:24', '', -1, 1),
(7, 4, 5, '2021-10-07 10:35:33', '', -1, 1),
(8, 4, 4, '2021-10-07 10:35:39', '', -1, 1),
(9, 4, 6, '2021-10-07 10:37:50', '', -1, 1),
(10, 4, 6, '2021-10-07 10:40:47', '', -1, 1),
(11, 4, 6, '2021-10-07 10:40:49', '', -1, 1),
(12, 4, 6, '2021-10-07 10:43:04', '', -1, 1),
(13, 4, 6, '2021-10-07 10:48:31', '', -1, 1),
(14, 4, 7, '2021-10-07 11:07:14', '', 10, -1),
(15, 4, 7, '2021-10-07 11:08:00', '', 10, -1),
(16, 4, 6, '2021-10-07 11:08:57', '', -1, 1),
(17, 5, 2, '2022-04-07 15:59:09', 'Commande passée par AEZR AZER', 11, -1);
...
INSERT INTO `salarie` (`idSalarie`, `nom`, `prenom`, `mail`, `idEntreprise`, `roleEntreprise`, `password`, `actif`, `bRGPD`, `dateRGPD`) VALUES
(10, 'test2', 'testaerbv', 'contact@lyceep.fr', 20, 'test', '$2y$10$UI.w13KAI/Nidcuj3CSeduyI3hrMYcCljgXAsnc/VLjhcvsfmpM.G', b'0', NULL, NULL),
(11, 'AEZR', 'AZER', 'AZER@AZER.COM', 20, 'AZER', '$2y$10$9NsgZLjP2pV2MJYs6lUFq.aPie9xF7dd3WF7qePMwf6EvAm0oy6Dm', b'1', 1, '2022-04-07 15:58:25');
...
INSERT INTO `token` (`id`, `valeur`, `dateTime`, `idUtilisateur`, `action`, `valide`) VALUES
(1, '$2y$10$KJ/DVfqhVPdJZzVCOaf/eeDNwTPOIkfp48egSpjvnHwf7lJCkeJMm', '2022-04-07 15:56:01', 11, 'Reset Salarie', 0);
...
(14, 'Clinassss', '$2y$10$3UEkiJWBLXQO7WwD1og4jOswXpA81obYGh.JXLZE4bcp.bcIuXv2C', 2, 0),
(15, 'ereqrh', '$2y$10$SDg.Hwwq1Su6DxF/AXnPfOdFhDDv1ziH/LGi3hL44rS/Bza9UyvNe', 3, 0),
(18, 'root', '$2y$10$qiRuqEmrobzVFuDRGmiv4ujkrGvcEqIcuM0IMKdmcPZFq9JsvxOFu', 1, 0);
...
--
ALTER TABLE `historique_etat_commande`
  MODIFY `idHistorique` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

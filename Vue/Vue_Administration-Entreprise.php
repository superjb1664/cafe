...
<nav id='menu'>
  <ul id='menu-closed'>  
    <li><a href='?action=Gerer_compteClient'>Mon compte</a></li> 
...
<nav id='menu'>
  <ul id='menu-closed'>  
    <li><a href='Controleur_Catalogue_client.php'>Catalogue</a></li> 
    <li><a href='Controleur_Gerer_compteClient.php'>Mon compte</a></li> 
    <li><a href='Controleur_Gerer_Panier.php'>Panier";
    if($quantiteMenu > 0)
    {
        echo " ($quantiteMenu) ";
    }
    echo "</a></li>
    <li><a href='Controleur_Gerer_CommandeClient.php'>Mes commandes</a></li> 
  </ul>
</nav> ";
}
        ...
        <tr>
            <td>
                <form style='display: contents'>
                    <input type='hidden' name='action' value='Gerer_compteClient'>

...
function Vue_ConsentementAffichage($msg=""){
    echo "<H1>Objet du traitement (finalité et base légale)</H1>
...
<br>
<form >
    <input type='hidden' name='action' value='ConsentementRGPD'>
    ...
    <input type='submit' value='Je donne mon accord' name='accordRGPD'>
</form>
$msg
";
}